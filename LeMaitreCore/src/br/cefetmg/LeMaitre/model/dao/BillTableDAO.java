...
public interface BillTableDAO {
    ...
    public boolean remove(String codToken, Integer tableID) throws PersistenceException;
    public List<Table> listTablesByToken(String codToken) throws PersistenceException;
