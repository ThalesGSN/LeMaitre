 ...
 */
@WebServlet(name = "BillUpdate", urlPatterns = {"/BillUpdate"})
public class BillUpdate extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (billManagement.billUpdate(bill)) {
                result.setStatusOK();
    ...
    private Bill billFromJson(String str) throws ParseException {
        gson = new Gson();
        BillUpdateAdapter billAdapter = gson.fromJson(str, BillUpdateAdapter.class);
        Bill bill =  billAdapter.getBill();
        return bill;
    }
}

class BillUpdateAdapter {
    ...
    public BillUpdateAdapter() {
    }

    
    public BillUpdateAdapter(String codToken, String datUse, char idtStatus) {
