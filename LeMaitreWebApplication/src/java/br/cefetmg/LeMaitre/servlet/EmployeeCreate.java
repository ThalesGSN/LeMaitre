 ...
 *
 * @author Thalesgsn
 * url: http://localhost:8080/LeMaitreWebApplication/EmployeeCreate
 */
@WebServlet(name = "EmployeeCreate", urlPatterns = {"/EmployeeCreate"})
public class EmployeeCreate extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int id = employeeManagement.employeeInsert(employee);
            employee.setCodID(id);
