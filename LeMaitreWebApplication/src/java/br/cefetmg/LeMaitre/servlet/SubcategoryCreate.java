 ...
 *
 * @author Thalesgsn
 * url: http://localhost:8080/LeMaitreWebApplication/SubcategoryCreate
 */
@WebServlet(name = "SubcategoryCreate", urlPatterns = {"/SubcategoryCreate"})
public class SubcategoryCreate extends HttpServlet { 
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int subID =  subcategoryManagement.subcategoryInsert(subcategory);
            subcategory.setSeqSubcategory(subID);
